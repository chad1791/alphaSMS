...
<head>
  ...
  <title>Alpha SMS | Notifications</title>
        ...
        <div class="col-xs-12">
          <div class="box">
            ...
            <div class="box-body table-responsive no-padding">
              <table class="table table-hover" id="noteTable"></table>
            </div>
            <!-- /.box-body -->
          </div>
          <!-- /.box -->
...
<script type="text/javascript" src="<?php echo base_url();?>/custom/js/student/notifications.js"></script>

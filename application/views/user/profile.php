...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <?php if($this->session->flashdata('teacherProUpdated_success')): ?>
        <?php echo '<p class="alert alert-success col-sm-11 col-md-11 col-lg-11" style="margin-left:15px;">'.$this->session->flashdata('teacherProUpdated_success').'</p>' ?>
      <?php endif ;?>

      <?php if($this->session->flashdata('teacherProUpdated_error')): ?>
        <?php echo '<p class="alert alert-danger col-sm-11 col-md-11 col-lg-11" style="margin-left:15px;">'.$this->session->flashdata('teacherProUpdated_error').'</p>' ?>
      <?php endif ;?>
        ...
        <div class="col-md-3">
          ...
          <div class="box box-primary">
            ...
            <div class="box-body box-profile">
              ...
              <div class="container">            
                <img class="profile-user-img img-responsive img-circle" id="picFrame" src="<?php if(count($profile) > 0){ if($profile[0]['image'] != ''){ echo base_url().'custom/uploads/teachers/images/'.$profile[0]['image']; }else{ echo base_url().'assets/dist/img/avatar04.png'; } }else{echo base_url().'assets/dist/img/avatar04.png';} ?>" alt="Profile picture">  
              ...
              <h3 class="profile-username text-center"><?php if(count($profile)>0){ echo $profile[0]['first'].' '.$profile[0]['last']; }else{ echo 'John Deo'; }?></h3>

              <p class="text-muted text-center"><?php if(count($profile)>0){ echo $profile[0]['subjects']; }else{ echo 'I.T Instructor'; }?></p>
          ...
          <hr>
                ...
                <p>
                  <?php if(count($profile)>0){ echo $profile[0]['des']; }else{ echo 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam fermentum enim neque.'; }?>
            ...
            <div class="tab-content">
              ...
              <div class="tab-pane active" id="settings">
                ...
                ?>
                  ...
                  <input type="hidden" name="teacher_id" id="teacher_id" value="<?php if(count($profile)>0){echo $profile[0]['id'];} ?>">
                  <div class="form-group">
                    <label for="first" class="col-sm-2 control-label">First Name</label>

                    <div class="col-sm-10">
                      <input type="text" value="<?php if(count($profile)>0){echo $profile[0]['first'];} ?>" class="form-control" id="first" name="first" placeholder="First Name">
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="middle" class="col-sm-2 control-label">Middle Name</label>

                    <div class="col-sm-10">
                      <input type="text" value="<?php if(count($profile)>0){echo $profile[0]['middle'];} ?>" class="form-control" id="middle" name="middle" placeholder="Middle Name">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" value="<?php if(count($profile)>0){echo $profile[0]['last'];} ?>" class="form-control" id="last" name="last" placeholder="Last Name">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="email" value="<?php echo $teacher_email; ?>" class="form-control" id="email" name="email" placeholder="Email" readonly>
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" value="<?php if(count($profile)>0){echo $profile[0]['phone'];} ?>" class="form-control" id="cell" name="cell" placeholder="Cell">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" value="<?php if(count($profile)>0){echo $profile[0]['address'];} ?>" class="form-control" id="address" name="address" placeholder="Address">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input type="text" value="<?php if(count($profile)>0){echo $profile[0]['subjects'];} ?>" class="form-control" id="post" name="post" placeholder="Post">
                    </div>
                  </div>
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <textarea class="form-control" id="education" name="education" placeholder="Education"><?php if(count($profile)>0){echo htmlspecialchars($profile[0]['education']) ;} ?></textarea>
                    </div>
                  </div>
                  <div class="form-group">
                    <label for="des" class="col-sm-2 control-label">About Me (500)</label>

                    <div class="col-sm-10">
                      <textarea class="form-control" id="des" name="des" placeholder="About Me"><?php if(count($profile)>0){echo htmlspecialchars($profile[0]['des']);} ?></textarea>
                    </div>
                  </div>
...
<script type="text/javascript" src="<?php echo base_url();?>/custom/js/user/profile.js"></script> 

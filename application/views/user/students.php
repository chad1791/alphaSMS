        ...
        <div class="col-md-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">My Students List</h3>
                            <!-- tools box -->
                  ...
                  if(count($students)>0){
                    ...
                    for ($i=0; $i < count($students) ; $i++) { 
                      ...
                      for ($row=0; $row < count($classList); $row++) { 
                        if($classList[$row]['id'] == $students[$i]['class_id']){
                      ...
                      echo '<tr id="'.$students[$i]['id'].'">'.
                           ...
                           '<td>'.$class.'</td>'.  
                           '<td>'.$active.'</td>'.
                           '<td><button class="btn btn-success" data-fnx="view" data-view_id="'.$students[$i]['id'].'"><i class="fa fa-eye"></i></button></td>'.
                           '</tr>';
                    }
                  }

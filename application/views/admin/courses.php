        ...
        <div class="col-md-12">
          ...
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Alpha SMS Course List</h3>
                            <!-- tools box -->
                ...
                <tbody>
                  <?php
                    ...
                    for ($i=0; $i < count($courses) ; $i++) { 
                      ...
                      echo '<tr id="'.$courses[$i]['id'].'">'.
                           '<td>'.$courses[$i]['short'].'</td>'.
                           '<td>'.$courses[$i]['name'].'</td>'.
                           '<td>'.$type.'</td>'.
                           '<td>'.$courses[$i]['description'].'</td>'.
                           '<td><button class="btn btn-success" data-fnx="view" data-view_id="'.$courses[$i]['id'].'" data-toggle="modal" data-target="#viewAdmin"><i class="fa fa-eye"></i></button>&nbsp;<button class="btn btn-primary" data-fnx="update" data-up_id="'.$courses[$i]['id'].'" data-toggle="modal" data-target="#updateAdmin"><i class="fa fa-pencil"></i></button>&nbsp;<button class="btn btn-danger" data-fnx="delete" data-rem_id="'.$courses[$i]['id'].'"><i class="fa fa-times"></i></button></td>'.
                           '</tr>';
                    }
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
               <form class="form-horizontal"> 
                  ...
                  <div class="form-group">
                    <label for="des" class="col-sm-3 control-label">Course Desc</label>
...
<script type="text/javascript" src="<?php echo base_url();?>/custom/js/admin/courses.js"></script>

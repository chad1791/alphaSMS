      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
          <a href="teachers">
            ...
            <span>Teachers</span>
            <span class="pull-right-container">
              <span class="label label-success pull-right"><?php if(count($teachers)>0){ echo count($teachers); }else{ echo '0'; } ?></span>
            </span>
          </a>
        </li>
        <li class="treeview">
          <a href="students">
            ...
            <span>Students</span>
            <span class="pull-right-container">
              <span class="label label-primary pull-right"><?php if(count($students)>0){ echo count($students); }else{ echo '0'; } ?></span>
            </span>
          </a>
        </li>
        <li class="treeview">
          <a href="classes">
            ...
            <span>Classes</span>
            <span class="pull-right-container">
              <span class="label label-warning pull-right"><?php if(count($classes)>0){ echo count($classes); }else{ echo '0'; } ?></span>
            </span>
          </a>
        </li>
        <li class="treeview">
          <a href="courses">
            ...
            <span>Courses</span>
            <span class="pull-right-container">
              <span class="label label-danger pull-right"><?php if(count($courses)>0){ echo count($courses); }else{ echo '0'; } ?></span>
            </span>
          </a>
        </li> 
        <!--li class="treeview">
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-green">
            <div class="inner">
              ...
              <p><?php if(count($teachers) == 1){ echo 'Teacher'; }else{ echo 'Teachers'; } ?></p>
            </div>
            <div class="icon">
              <i class="fa fa-black-tie"></i>
            </div>
        ...
        <div class="col-lg-3 col-xs-6">
          ...
          <div class="small-box bg-red">
            <div class="inner">
              ...
              <p><?php if(count($courses) == 1){ echo 'Course'; }else{ echo 'Courses'; } ?></p>
            </div>
            <div class="icon">
              <i class="fa fa-mortar-board"></i>
            </div>
              ...
              <div class="btn-group" style="width: 100%; margin-bottom: 10px;" id="myEventsList">
                ...
                <?php 
                  for ($i=0; $i < count($myEvents) ; $i++) { 
                    ...
                    $titleShort = substr($myEvents[$i]['title'], 0, 18);
                  ...
                  for ($i=0; $i < count($sharedEvents) ; $i++) { 
                    ...
                    $titleShort = substr($sharedEvents[$i]['title'], 0, 18);
            ...
            <div class="modal-content">
              ...
              <div class="modal-body">
                ...
                ?> 
                  ...
                  <div class="form-group">
                    <label for="upEventLink" class="col-sm-3 control-label">Description</label>  
                    <div class="col-sm-9">
                      <textarea type="text" rows="4" class="form-control" id="upDesc" name="upDesc" placeholder="Type your event description"></textarea>
                    </div>
                  </div>                  
                  <div class="form-group">
...
<script>
  $(function () {
    ...
    function addListenerToEventBtns(){
      ...
      updateEvent
        ...
        .on('click',function(e){
          ...
          var jqxhr = $.ajax({
            url: 'Admins/updateMyEventUrlShares',  
            dataType:'json',
            type:'post',
            data: {id:eventId, url:url, shareGroup:shareGroup, des:des}           
          })          
    ...
    //ajax to get my calendar events...
      ...
      $.ajax({
        method: "POST",
        url: "Admins/getAllMyEvents",
        dataType: "json",
        data: { owner_id:<?php echo $this->session->userdata('admin_id'); ?> }
      })
      .done(function( response ) {
        ...
        $.ajax({
          method: "POST",
          url: "Admins/getAllSharedEvents",
          dataType: "json",
          data: { owner_id:<?php echo $this->session->userdata('admin_id'); ?>, group:'2' }
        })
        .done(function(response){
    ...
    function fetchDefaultEvents(){
        ...
        $.ajax({
          method: "POST",
          url: "Admins/getAllDefaultEvents",
          dataType: "json",
          data: { owner_id:<?php echo $this->session->userdata('admin_id'); ?> }
        })
        .done(function( response ) {
    ...
    $("#add-new-event").click(function (e) {
      ...
      var jqxhr = $.ajax({
        url: 'Admins/addDefaultEvent',  
        //dataType:'json',
        type:'post',
        data: {owner_id:<?php echo $this->session->userdata('admin_id'); ?>, table_name:'admin_log', title:val, color:'#fff', bground:currColor, border:currColor}           
      })          
      .done(function(response) {
